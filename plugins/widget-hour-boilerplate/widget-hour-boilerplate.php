<?php
/**
 * @package   buisness-hour-widget
 * @author    Hanin Mustafa <haninmustafa13@gmail.com>
 * @license   GPL-2.0+
 * @link      http://www.redacademy.com
 * @copyright 2016 Red Academy
 *
 * @wordpress-plugin
 * Plugin Name:       widget hour boilerplate
 * Plugin URI:        http://www.redacademy.com
 * Description:       A custom buisniss for hours
 * Version:           1.0.0
 * Author:            Hanin Mustafa
 * Author URI:        haninmustafa13@gmail.com
 * License:           GPL-2.0+
...
// TODO: change 'buisness-hour-widget' to the name of your plugin
class Buisness_Hour_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'buisness-hour-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'Buisness Hour Widget',
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => 'Add the buisniss weekly hours.'
			)
		);
...
// TODO: Remember to change 'buisness-hour-widget' to match the class name definition
add_action( 'widgets_init', function(){
     register_widget( 'Buisness_Hour_Widget' );
});
